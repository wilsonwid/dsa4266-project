...
def train_model(
    ...
    trained_model = ray.get(trained_model)
...
if __name__ == "__main__":
    ...
    lstm_directory = "/home/wilsonwid/ray_results/train_model_2024-11-13_15-17-53/train_model_66281_00002_2_bidirectional=False,dropout_prob=0.2000,hidden_size=8,lr=0.0008,num_lstm_layers=4,steps=128_2024-11-13_15-17-53/checkpoint_000000"

    with open(f"{lstm_directory}/data.pkl", "rb") as f:
        checkpoint_data = pickle.load(f)
        best_trained_model.load_state_dict(checkpoint_data["net_state_dict"])

    lstm_model_id = ray.put(best_trained_model)
    ...
    test_dataset = VideoDataset(
        ...
        clip_len=lstm_search_space["steps"],
        include_additional_transforms=lstm_search_space["include_additional_transforms"],
        random_transforms=None
    )

    test_loader = DataLoader(
        dataset=test_dataset, 
        batch_size=int(lstm_search_space["batch_size"]),
        num_workers=NUM_WORKERS
    )
