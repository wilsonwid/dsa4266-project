...
class ConvBlock(nn.Module):
    ...
    def __init__(
        ...
        self.bn1 = nn.BatchNorm3d(num_features=self.num_kernels)
        ...
        self.bn2 = nn.BatchNorm3d(num_features=self.num_kernels * 2)
...
class CNN_LSTM(nn.Module):
    def __init__(
        ...
        self.bn = nn.BatchNorm3d(num_features=self.num_start_kernels)
        ...
        self.fc1 = nn.Linear((2 if self.bidirectional else 1) * self.hidden_size * self.step_size_after_activation, 64)
