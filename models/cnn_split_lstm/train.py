...
if __name__ == "__main__":
    ...
    cnn_search_space = {
        ...
        "padding": tune.choice([1, 2, 3, 4, 5, 6]),
    ...
    best_cnn_result = cnn_result.get_best_trial("acc", "max", "last")
    ...
    best_cnn_checkpoint = best_cnn_result.get_best_checkpoint(trial=best_cnn_result, metric="acc", mode="max")
